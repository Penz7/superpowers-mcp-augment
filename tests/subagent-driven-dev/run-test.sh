...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/superpowers-mcp-augment
...
PROMPT="Execute this plan using superpowers-mcp-augment:subagent-driven-development. The plan is at: $PLAN_PATH"
