...
echo "  claude -p \"Execute this plan using superpowers-mcp-augment:subagent-driven-development. Plan: $TARGET_DIR/plan.md\" --plugin-dir /path/to/superpowers-mcp-augment"
